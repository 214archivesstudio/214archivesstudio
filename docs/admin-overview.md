...
manual/                               # VitePress 사용자 매뉴얼 소스 + 단일 파일 번들러; 산출물 public/admin/manual.html (어드민 /admin/manual.html 에서 열람, 로그인 필요); 빌드 `cd manual && npm run bundle`
```
...
- ~~사용자 매뉴얼~~ — 2026-08-31 완료: [public/admin/manual.html](../public/admin/manual.html) (어드민 헤더 "가이드 ↗") (VitePress 17페이지 · 스크린샷 25장 · 오프라인 단일 파일)
...
- 사용자 매뉴얼 (단일 HTML): [public/admin/manual.html](../public/admin/manual.html) (어드민 헤더 "가이드 ↗")
