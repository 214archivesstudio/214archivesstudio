...
export const ARCHIVES: ReadonlyArray<ArchiveItem> = [
  ...
  createArchive("25-newyork", "NEWYORK", "2025", "2024-08-30", 53),
  createArchive("24-dubai", "DUBAI", "2024", "2024-02-20", 33),
  createArchive("23-hongkong", "HONGKONG", "2023", "2023-11-18", 18),
  createArchive("23-hochiminh", "HOCHIMINH", "2023", "2023-08-25", 14),
